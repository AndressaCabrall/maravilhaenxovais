...
export const metadata = {
  ...
  description: 'Cortinas e persianas sob medida em Tabatinga SP. Instalação não inclusa. Atendimento da Maravilha Cortinas de Ibitinga — ateliê especializado, +16 anos.',
...
const faq = [
  ...
  { q: 'Como funciona a consultoria?', a: 'Pelo WhatsApp — respondemos rápido e alinhamos disponibilidade de agenda para Tabatinga.' },
]
...
const diferenciais = [
  { num: '01', titulo: 'Consultoria personalizada', desc: 'Vamos até você em Tabatinga e ajudamos a escolher o tecido certo para o seu ambiente. Medição profissional antes de qualquer compromisso.' },
        ...
        <div className={styles.container}>
          ...
          <header className={styles.header}>
            ...
            <p className={styles.sub}>
              Um ateliê especializado de Ibitinga — consultoria personalizada e instalação profissional disponível em Tabatinga e região. Instalação possui custo adicional.
            </p>
