...
const WA = whatsappUrl('Olá! Vi o site e gostaria de solicitar um orçamento em Tabatinga.')

export const metadata = {
  title:       'Cortinas e Persianas Sob Medida em Tabatinga SP',
  description: 'Cortinas e persianas sob medida em Tabatinga SP. Instalação não inclusa. Atendimento da Maravilha Cortinas de Ibitinga — +16 anos de experiência.',
...
const faq = [
  { q: 'A Maravilha Cortinas atende em Tabatinga?', a: 'Sim! Tabatinga fica a ~25km de Ibitinga e está dentro da nossa área de atendimento. Consulte disponibilidade e condições de visita pelo WhatsApp.' },
  ...
  { q: 'Como faço para agendar?', a: 'Pelo WhatsApp — respondemos rápido e alinhamos disponibilidade de agenda para Tabatinga.' },
]
...
const diferenciais = [
  { num: '01', titulo: 'Visita de medição', desc: 'Vamos até você em Tabatinga mediante agendamento. Medição profissional antes de qualquer compromisso.' },
        ...
        <div className={styles.container}>
          ...
          <header className={styles.header}>
            ...
            <p className={styles.sub}>
              Atendimento da Maravilha Cortinas de Ibitinga — instalação profissional disponível em Tabatinga e região. Instalação possui custo adicional.
            </p>
            <a href={WA} target="_blank" rel="noopener noreferrer" className={styles.ctaHero}>
              Agendar visita em Tabatinga →
            </a>
          </header>
          ...
          <section className={styles.sec}>
            ...
            <p className={styles.texto}>A Maravilha Cortinas atende Tabatinga com toda a linha de cortinas e persianas sob medida. Somos Loja da Fábrica em Ibitinga — produzimos sob medida sem intermediários há mais de 16 anos. Instalação sob consulta.</p>
