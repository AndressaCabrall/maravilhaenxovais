...
export const metadata = {
  ...
  description: 'Cortinas e persianas sob medida em Matão SP, de alto padrão. Consultoria personalizada, ateliê especializado, +16 anos. Instalação sob consulta.',
...
const diferenciais = [
  { num: '01', titulo: 'Consultoria personalizada', desc: 'Consultoria personalizada para Matão: ajudamos a escolher o tecido e o modelo certos para o seu ambiente.' },
