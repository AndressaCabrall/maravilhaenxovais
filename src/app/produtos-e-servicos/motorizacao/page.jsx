...
const schema = {
  ...
  areaServed:  'BR',
  description: 'Consultoria personalizada em motorização de cortinas e persianas com controle pelo celular, Alexa e Google Home. O ateliê é em Ibitinga, mas atendemos em todo o Brasil.',
}
    ...
    <>
      ...
      <main>
        <HeroPagina
          ...
          sub="Em consultoria, avaliamos onde a motorização faz diferença: da luz natural que entra aos poucos ao comando de voz antes de dormir. O detalhe que separa um imóvel comum de um imóvel premium — o ateliê é em Ibitinga, mas atendemos em todo o Brasil."
            ...
            <div className={styles.introGrid}>
              <div>
                ...
                <p className={styles.introTexto}>
                  Motorize cortinas e persianas com consultoria sobre onde a automação faz diferença no seu ambiente. Controle remoto, smartphone ou voz — integração com Alexa e Google Home. O ateliê é em Ibitinga, mas atendemos em todo o Brasil. Instalação sob consulta.
                </p>
